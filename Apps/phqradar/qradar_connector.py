...
class QradarConnector(BaseConnector):
    ...
    def initialize(self):
        ...
        try:
            self._events_ingest_start_time = int(self._events_ingest_start_time)
    ...
    def _on_poll(self, param):
        ...
        for i, offense in enumerate(offenses):
            ...
            self.save_progress('Back-dating the offense start time by {} minutes'.format(self._events_ingest_start_time))
    ...
    def _list_offenses(self, param, action_result=None):
        ...
        while True:
            ...
            try:
                ...
                self.debug_print("Unable to parse response of 'call_api' for fetching offenses as a valid JSON", e)
